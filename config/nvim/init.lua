-- I copied this init.lua file shamelessly and egregiously from github:Hoverbear-Consulting/flake
...
local on_attach = function(client,bufnr)
	...
	buf_set_option('omnifunc', 'v:lia.vim.lsp.omnifunc')
	...
	buf_set_keymap('n', '<space>wl', '<cmd>lua print(vim.inspec(vim.lsp.buf.list_workspace_folders()))<CR>', opts)
...
require'nvim-treesitter.configs'.setup {
	...
	highlight = {
		...
		-- Set this to true only if you depend on `syntax` being enabled.
		-- Using this may slow down your editor
